...
<div class="widget-content">
	<table class="table table-striped table-bordered">
		...
		if($_SESSION['serie'] == 1 OR $_SESSION['serie'] == 2){
			...
			$projects = mysql_query("SELECT * FROM registers R INNER JOIN turmas T ON T.idProfessor = $id WHERE group1 = T.turma AND R.series = T.serie AND R.status <> 3 AND R.status <> 99");
		}
